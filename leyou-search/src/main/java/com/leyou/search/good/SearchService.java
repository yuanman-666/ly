...
import com.leyou.search.utils.JsonUtils;
import com.leyou.search.utils.NumberUtils;
...
public class SearchService {
    ...
    private List<Map<String, Object>> getSpec(Long id, QueryBuilder basicQuery) {
        ...
        String specsJSONStr = this.specClient.querySpecificationByCategoryId((long)id).getBody();
        //1.将规格反序列化为集合
        List<Map<String,Object>> specs = null;
